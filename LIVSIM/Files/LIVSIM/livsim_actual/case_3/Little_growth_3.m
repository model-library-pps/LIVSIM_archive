...
%Little growth subroutine for lactating cows
%version May 2009  ---Mariana Rufino
%--------------------------------------------------------------------------

function [COW]=Little_growth_3(COW,COW_OLD,PARAM)

growth_max  =COW.CHAR.GrowthLastMonth; %the growth to achieve potential this timestep
growth_min  =0;
...
while abs(COW.INPUT.ME-NeedsEnergy)>=tolerance
    ...
    NeedsEnergy       =PARAM.AFRC.Mmp*PARAM.AFRC.CL + COW.NEED.LactME;
...
%Update Balance
% 
% BALANCE.MP=COW.INPUT.MP/(COW.NEED.MaintMP+COW.NEED.GrowthMP+COW.NEED.LactMP);
% 
%if MP input is not enough, reduce growth further
%  if BALANCE.MP<1
%      need_to_go_to_LGP3=1
% %     pause
%      Little_growth_prot_3
%  end
