%------------------------------little growth prot 2--------------------------------------

%Little growth for pregnant animals prot deficient diet
%version Update May 2009 ---Mariana Rufino
%--------------------------------------------------------------------------

function [COW]=Little_growth_prot_2(COW,COW_OLD,PARAM)
...
while abs(COW.INPUT.MP-NeedsProt)>tolerance
    ...
    NeedsProt         =(PARAM.AFRC.MPm+PARAM.AFRC.MPf)/1000*PARAM.SYS.YLEN*PARAM.SYS.timestep + COW.NEED.GestMP;
...
%Update balance
% 
% BALANCE.ME=COW.INPUT.ME/(COW.NEED.MaintME+COW.NEED.GrowthME+COW.NEED.GestME); 
% 
%  if BALANCE.ME<1
%      Little_growth_2
%      need_to_go_to_LG2=1
