%------------------------------Little_growth_prot_4--------------------------------------

%Little growth for lactating and pregnant animals prot deficient diet
%version Updated May 2009 ---Mariana Rufino
%--------------------------------------------------------------------------

function [COW]=Little_growth_prot_4(COW,COW_OLD,PARAM)
...
while abs(COW.INPUT.MP-NeedsProt)>tolerance
    ...
    NeedsProt         =(PARAM.AFRC.MPm+PARAM.AFRC.MPf)/1000*PARAM.SYS.YLEN*PARAM.SYS.timestep + COW.NEED.GestMP + COW.NEED.LactMP;
...
COW.NEED.GrowthME        =PARAM.AFRC.CL*PARAM.AFRC.Mmp-COW.NEED.MaintME; %maintenance plus growth

%Check whether protein is enough to achieve calculated little growth -
%Update Balance
% 
% BALANCE.ME=COW.INPUT.ME/(COW.NEED.MaintME+COW.NEED.GrowthME+COW.NEED.LactME+COW.NEED.Gest.ME);
% 
