...
%Little growth sub-routine for lactating and pregnant
%version Updated May 2009---Mariana Rufino
%--------------------------------------------------------------------------

function [COW]=Little_growth_4(COW,COW_OLD,PARAM)
...
while abs(COW.INPUT.ME-NeedsEnergy)>=tolerance
    ...
    NeedsEnergy       =PARAM.AFRC.Mmp*PARAM.AFRC.CL + COW.NEED.GestME + COW.NEED.LactME;
...
%Update Balance
% 
%BALANCE.MP=COW.INPUT.MP/(COW.NEED.MaintMP+COW.NEED.GrowthMP+COW.NEED.LactMP+COW.NEED.Gest.MP);
% 
%if MP input is not enough, reduce growth further
% if BALANCE.MP<1
%     need_to_go_to_LGP4=1
%     pause    
